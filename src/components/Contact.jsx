...
const CONTACTS = [
  {
    Icon: Mail,
    label: "Email",
    val: "rushikeshingole467@gmail.com",
  ...
  },
  {
    Icon: Linkedin,
    label: "LinkedIn",
    val: "rushikesh-ingole-b02052377",
    ...
    >
      <div style={{ maxWidth: 1060, margin: "0 auto" }}>
        ...
        >
          ...
          <p className="sec-sub">
            Open to full-time roles, internships, freelance analytics projects,
            and collaborations.
          </p>
        ...
        >
          {CONTACTS.map(({ Icon, label, val, href, color, action, ext }, i) => (
            <motion.a
              ...
              className="glass btn btn-clip corner-box"
              onClick={(e) => addRipple(e, `${color}20`)}
              style={{
                display: "flex",
                alignItems: "center",
                gap: "clamp(11px,2.5vw,15px)",
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = `0 10px 28px ${color}16`;
              }}
              onMouseLeave={(e) => {
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              height: 140,
              background:
                "radial-gradient(circle,rgba(123,47,247,.07),transparent 70%)",
              pointerEvents: "none",
              animationDelay: "-3s",
            }}
          />
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              Whether you need a data analyst, BI developer or analytics
              consultant — I'm available and excited.
            </p>
            <div
              style={{
                display: "flex",
            ...
            >
              {[
                ...
                <motion.a
                  ...
                  onClick={(e) => addRipple(e, "rgba(255,255,255,.16)")}
                  style={{
                    display: "inline-flex",
                    alignItems: "center",
                    gap: 7,
                    padding: "clamp(9px,2.2vw,12px) clamp(16px,3vw,22px)",
                    fontFamily: "var(--font-display)",
                    fontWeight: 700,
