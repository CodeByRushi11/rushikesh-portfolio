  ...
  return (
    <div
      style={{
        ...
        borderRadius: "50%",
        opacity: 0.3,
        animation: `${anim} ${8}s ease-in-out infinite`,
...
export default function About() {
  return (
    <section
      ...
      style={{
        background: "var(--bg2)",
        padding: "clamp(60px,9vw,100px) 20px 0",
        position: "relative",
        overflow: "hidden",
      }}
    >
          ...
          >
            {[
              <>
                ...
                transforming data into actionable business insights that drive
              ...
              {HIGHLIGHTS.map(({ Icon, label, color }, i) => (
                ...
                >
                  ...
                  >
                    <Icon
                      size={14}
                      style={{ color, transition: "color .25s" }}
                    />
                  </div>
                  <span
                    style={{
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: 90,
                  background:
                    "radial-gradient(circle,rgba(123,47,247,.06),transparent 70%)",
                  pointerEvents: "none",
                }}
              />
              <h3
